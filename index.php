                ...
                <form method="post" action="/assets/php/dbRegistration.php" class="contact-form__form">
                    <div class="contact-form__name">
                        <div class="contact-name__errors">
                            <input class="contact-form__input" type="text" name="name" placeholder="Twoje imię" required value="<?php echo isset($formData['name']) ? $formData['name'] : 'Tonya'; ?>">
                            <label id="name_error" class="error"><?php echo isset($errorContainer['name']) ? $errorContainer['name'] : "" ?></label>
                        </div>

                        <div class="contact-name__errors">
                            <input class="contact-form__input" type="text" placeholder="Twoje nazwisko" name="surname" required value="<?php echo isset($formData['surname']) ? $formData['surname'] : 'Radyno'; ?>">
                            <label id="surname_error" class="error"><?php echo isset($errorContainer['surname']) ? $errorContainer['surname'] : "" ?></label>
                        </div>

                        <div class="contact-name__errors">
                            <input class="contact-form__input" type="text" name="patronymic" placeholder="Twoje drugie imię" value="<?php echo isset($formData['patronymic']) ? $formData['patronymic'] : 'Leonovna'; ?>">
                            <label id="patronymic_error" class="error"><?php echo isset($errorContainer['patronymic']) ? $errorContainer['patronymic'] : "" ?></label>
                        </div>
                    </div>
                    <div class="contact-name__errors">
                        <input
                            placeholder="Twoja data urodzenia" class="contact-form__input" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="date" value="<?php echo isset($formData['name']) ? $formData['date'] : '08.01.2012'; ?>">
                    ...
                    <div class="contact-form__phone">
                        ...
                        <div class="contact-name__errors">
                            <input class="contact-form__input" type="tel" name="phone" placeholder="Telefon" value="<?php echo isset($formData['phone']) ? $formData['phone'] : '1234567'; ?>">
